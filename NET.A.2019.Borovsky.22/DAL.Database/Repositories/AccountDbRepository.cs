...
namespace DAL.Database.Repositories
{
    public class AccountDbRepository : IRepository
    {
        ...
        /// </summary>
        /// <param name="context">Data context used to interact with database</param>
        ...
        /// <returns>Bank account DTO object with id</returns>
        ...
        /// </summary>
        /// <param name="account">Account DTO object to update</param>
